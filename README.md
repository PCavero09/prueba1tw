...
<head>
    ...
    <!-- Opcional: Un pequeño retraso para asegurar que la detección del userAgent ocurra antes de la redirección.
         Puede que no sea estrictamente necesario para la mayoría de los casos modernos. -->
    <script>
        ...
        // Se ejecuta tan pronto como el script es parseado por el navegador
        ...
        if (/android/i.test(userAgent)) {
            ...
            // Fallback para dispositivos de escritorio o desconocidos.
            // Para una redirección "directa" sin botón, y si no es iOS, asumimos Android como fallback primario.
            // Si tienes una página web general de la app, podrías redirigir ahí en su lugar.
            redirectToStore(androidAppUrl); 
        }
    </script>
</head>
<body>
    <!-- Este contenido solo se mostrará si JavaScript está deshabilitado.
         En la mayoría de los dispositivos modernos, JavaScript está habilitado. -->
    <noscript>
